...
(function($) {
	$.fn.EAN13 = function(number, print_number) {
	
		// check if print_number is defined
		print_number = typeof print_number !== 'undefined' ? print_number : true;
